      ...
      <div class="alert alert-success" role="alert">
        ...
        <?php if (ceil($countOrder / $num_results_on_page) > 0): ?>
          <ul class="pagination">
            ...
            <?php if ($page+1 < ceil($countOrder / $num_results_on_page)+1): ?><li class="page-item"><a class="page-link" href="index.php?page=<?php echo $page+1 ?>"><?php echo $page+1 ?></a></li><?php endif; ?>
            <?php if ($page+2 < ceil($countOrder / $num_results_on_page)+1): ?><li class="page-item"><a class="page-link" href="index.php?page=<?php echo $page+2 ?>"><?php echo $page+2 ?></a></li><?php endif; ?>

            <?php if ($page < ceil($countOrder / $num_results_on_page)-2): ?>
            <li class="page-item"><a class="page-link" href="index.php?page=<?php echo ceil($countOrder / $num_results_on_page) ?>"><?php echo ceil($countOrder / $num_results_on_page) ?></a></li>
            <?php endif; ?>
